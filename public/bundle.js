    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = "Results with Roger";
    			t2 = space();
